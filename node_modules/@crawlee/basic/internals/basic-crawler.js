...
class BasicCrawler {
    ...
    constructor(options = {}, config = core_1.Configuration.getGlobalConfig()) {
        ...
        minConcurrency, maxConcurrency, maxRequestsPerMinute, retryOnBlocked = false, respectRobotsTxtFile = false, 
        // internal
    ...
    async _runTaskFunction() {
        ...
        if (!(await this.isAllowedBasedOnRobotsTxtFile(request.url))) {
            this.log.debug(`Skipping request ${request.url} (${request.id}) because it is disallowed based on robots.txt`);
